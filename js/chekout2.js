...
function post(token) {
    ...
    $.post("codes/verificaCurso.php", {curso: $curso, correo: $correo}, function (data) {
        if (data == "Ya adquirido"){
            alertify.alert("El curso ya ha sido adquirido con esta cuenta", function () {
